...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
        <img src="images/slide-img-3.jpg" style="width:100%">
    </div>

    <div class="mySlides fade">
        <img src="images/slide-img-1.jpg" style="width:100%">
    </div>

    <div class="mySlides fade">
        <img src="images/slide-img-2.jpg" style="width:100%">
    </div>
...
<div class="index-product-title">
    ...
    <!-- <div class="index-popular-para">
        <p>These are the most Popular Products</p>
    </div> -->
</div>
...
<?php 
    ...
    $sql = "SELECT * FROM `products` WHERE `pro_price` <= 1000";
...
<?php 
    ...
    $sql = "SELECT * FROM `products` WHERE `pro_category` = 1 AND `pro_price` >= 1000";
